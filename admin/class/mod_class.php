...
if (!isset($_GET)) {
    die("unexpected $_GET, parameters missing");
}
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="./do_mod_class.php" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="classname" name="classname" size="50"
                                       value="<?php echo $class['classname'] ?>" type="text" required autofocus>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th>类别描述：</th>
                            <td>
                                <textarea name="description" class="common-textarea" id="content" cols="30"
                                          style="width: 98%;" rows="10"><?php echo $class['description'] ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th></th>
